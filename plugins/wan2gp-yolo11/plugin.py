...
def predict_image(
    ...
    try:
        ...
        results = model.predict(source=img_small, **kwargs)
...
def predict_video(
    ...
    try:
        ...
        while True:
            ...
            results = model.predict(frame_rgb_small, **predict_kwargs)
...
def predict_frame_from_webcam(
    ...
    if device and device.lower() != "auto":
        kwargs["device"] = device
    start = time.perf_counter()
    results = model.predict(frame_small, **kwargs)
            ...
            with gr.Tabs():
                with gr.Tab("Image"):
                    ...
                    with gr.Row():
                        ...
                        device_img = gr.Dropdown(["auto", "cpu", "0", "1"], value="auto", label="Device")
                ...
                with gr.Tab("Video (file)"):
                    ...
                    with gr.Row():
                        ...
                        device_vid = gr.Dropdown(["auto", "cpu", "0", "1"], value="auto", label="Device")
                ...
                with gr.Tab("Webcam (live)"):
                    with gr.Row():
                        ...
                        device_cam = gr.Dropdown(["auto", "cpu", "0", "1"], value="auto", label="Device")
